...
function Sites(config) {
  ...
  if (!localStorage.maxDisplayNumber) {
    localStorage.maxDisplayNumber = 5;
  }
}
...
/**
 * return the number of maxDisplayNumber
 */
Object.defineProperty(Sites.prototype, "maxDisplayNumber", {
  get: function() {
    return localStorage.maxDisplayNumber;
  }
});
